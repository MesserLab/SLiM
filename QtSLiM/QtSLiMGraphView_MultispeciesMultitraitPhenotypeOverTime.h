...
#ifndef QTSLIMGRAPHVIEW_MULTISPECIESMULTITRAITPHENOTYPEOVERTIME_H
#define QTSLIMGRAPHVIEW_MULTISPECIESMULTITRAITPHENOTYPEOVERTIME_H
...
class QtSLiMGraphView_MultispeciesMultitraitPhenotypeOverTime : public QtSLiMGraphView
{
    Q_OBJECT
    
public:
    QtSLiMGraphView_MultispeciesMultitraitPhenotypeOverTime(QWidget *p_parent, QtSLiMWindow *controller);
    virtual ~QtSLiMGraphView_MultispeciesMultitraitPhenotypeOverTime() override;
...
#endif // QTSLIMGRAPHVIEW_MULTISPECIESMULTITRAITPHENOTYPEOVERTIME_H
