...
void SLiMSim::InjectIntoInterpreter(ScriptInterpreter &p_interpreter, SLiMScriptBlock *p_script_block)
{
	...
	if (generation_ != 0)
	{
		...
		if (p_script_block->contains_sim_)
		...
		if (p_script_block->contains_gX_)
		...
		if (p_script_block->contains_mX_)
		...
		if (p_script_block->contains_pX_)
		...
		if (p_script_block->contains_sX_)
			for (SLiMScriptBlock *script_block : script_blocks_)
