...
void SLiMSim::ReadProvenanceTable(table_collection_t *p_tables, slim_generation_t *p_generation, SLiMModelType *p_model_type, const char **p_file_version)
{
#if 0
	...
	*p_remembered_genome_count = (size_t)rem_count_ll;
	...
	else if (file_version_02.is_string())
	{
		...
		if (file_version_02 == "0.2")
			*p_file_version = SLIM_TREES_FILE_VERSION_PRENUC;
		else if (file_version_02 == "0.3")
			*p_file_version = SLIM_TREES_FILE_VERSION;
		else
			EIDOS_TERMINATION << "ERROR (SLiMSim::ReadProvenanceTable): this .trees file was generated by an unrecognized version of SLiM; this file cannot be read." << EidosTerminate();
...
#warning use file_version to read mutation metadata with the appropriate structure
