...
EidosValue_SP Individual::GetProperty(EidosGlobalStringID p_property_id)
{
	...
	switch (p_property_id)
	{
		...
		case gID_haploidGenome1:
		case gID_haploidGenome1NonNull:
			/*
...
const std::vector<EidosPropertySignature_CSP> *Individual_Class::Properties(void) const
{
	...
	if (!properties)
	{
		...
		properties->emplace_back((EidosPropertySignature *)(new EidosPropertySignature(gStr_haploidGenome1,	true,	kEidosValueMaskObject, gSLiM_Haplosome_Class)));
		properties->emplace_back((EidosPropertySignature *)(new EidosPropertySignature(gStr_haploidGenome2,	true,	kEidosValueMaskObject, gSLiM_Haplosome_Class)));
		properties->emplace_back((EidosPropertySignature *)(new EidosPropertySignature(gStr_haploidGenome1NonNull,	true,	kEidosValueMaskObject, gSLiM_Haplosome_Class)));
		properties->emplace_back((EidosPropertySignature *)(new EidosPropertySignature(gStr_haploidGenome2NonNull,	true,	kEidosValueMaskObject, gSLiM_Haplosome_Class)));
