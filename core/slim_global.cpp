...
void SLiM_RegisterGlobalStringsAndIDs(void)
{
	...
	if (!been_here)
	{
		...
		SLiMScript_RegisterStringForGlobalID(gStr_changeRecombinationIntervals, gID_changeRecombinationIntervals);
		...
		SLiMScript_RegisterStringForGlobalID(gStr_changeGenomicElementType, gID_changeGenomicElementType);
		SLiMScript_RegisterStringForGlobalID(gStr_changeMutationFractions, gID_changeMutationFractions);
		SLiMScript_RegisterStringForGlobalID(gStr_setSelectionCoeff, gID_setSelectionCoeff);
		SLiMScript_RegisterStringForGlobalID(gStr_changeDistribution, gID_changeDistribution);
