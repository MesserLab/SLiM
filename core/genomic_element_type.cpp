...
#pragma unused (p_method_id, p_arguments, p_interpreter)
	...
	{ 
		...
		if ((proportion < 0) || !std::isfinite(proportion))		// == 0 is allowed but the muttype will not be added; see also InitializeDraws()
		...
		// BCH 1/4/2026: new policy: if the muttype's proportion is zero, we don't really consider it to be used.
		// This allows our decisions about whether the simulation is neutral or not to be more accurate.
		if (proportion > 0.0)
		{
