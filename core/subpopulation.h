...
public:
	...
	ScriptValue *cached_value_subpop_id_ = nullptr;	// OWNED POINTER: a cached value for subpopulation_id_; delete and nil if changed
	...
	std::vector<SLiMScriptBlock*> registered_mate_choice_callbacks_;	// NOT OWNED: valid only during EvolveSubpopulation; callbacks used when this subpop is parental
	std::vector<SLiMScriptBlock*> registered_modify_child_callbacks_;	// NOT OWNED: valid only during EvolveSubpopulation; callbacks used when this subpop is parental
