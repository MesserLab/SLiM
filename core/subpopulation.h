...
public:
	...
	IndividualSex SexOfChild(int p_child_index);													// return the sex of the child at the given index
...
inline __attribute__((always_inline)) int Subpopulation::DrawParentUsingFitness(void) const
{
	...
	if (sex_enabled_)
	{
		std::cerr << "Subpopulation::DrawIndividual() called on a population for which sex is enabled" << std::endl;
		exit(EXIT_FAILURE);
	}
#endif
...
inline __attribute__((always_inline)) int Subpopulation::DrawParentEqualProbability(void) const
{
	...
	if (sex_enabled_)
	{
		std::cerr << "Subpopulation::DrawIndividualEqualProbability() called on a population for which sex is enabled" << std::endl;
		exit(EXIT_FAILURE);
	}
#endif
...
inline __attribute__((always_inline)) int Subpopulation::DrawFemaleParentUsingFitness(void) const
{
	...
	if (!sex_enabled_)
	{
		std::cerr << "Subpopulation::DrawFemale() called on a population for which sex is not enabled" << std::endl;
		exit(EXIT_FAILURE);
	}
#endif
...
inline __attribute__((always_inline)) int Subpopulation::DrawFemaleParentEqualProbability(void) const
{
	...
	if (!sex_enabled_)
	{
		std::cerr << "Subpopulation::DrawFemaleEqualProbability() called on a population for which sex is not enabled" << std::endl;
		exit(EXIT_FAILURE);
	}
#endif
...
inline __attribute__((always_inline)) int Subpopulation::DrawMaleParentUsingFitness(void) const
{
	...
	if (!sex_enabled_)
	{
		std::cerr << "Subpopulation::DrawMale() called on a population for which sex is not enabled" << std::endl;
		exit(EXIT_FAILURE);
	}
#endif
...
inline __attribute__((always_inline)) int Subpopulation::DrawMaleParentEqualProbability(void) const
{
	...
	if (!sex_enabled_)
	{
		std::cerr << "Subpopulation::DrawMaleEqualProbability() called on a population for which sex is not enabled" << std::endl;
		exit(EXIT_FAILURE);
	}
#endif
