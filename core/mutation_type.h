...
public:
	...
	inline __attribute__((always_inline)) bool LoggingOn(void) const { return mutation_logging_on_; }
	inline __attribute__((always_inline)) void LogMutationInfo_AUTOGENERATED(Mutation *p_mut) { _LogMutationInfo(p_mut); }
	inline __attribute__((always_inline)) void LogMutationInfo_SCRIPTED(Mutation *p_mut) { if (!log_autogeneratedOnly_)  _LogMutationInfo(p_mut); }
