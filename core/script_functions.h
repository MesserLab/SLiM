...
typedef ScriptValue *(*SLiMDelegateFunctionPtr)(void *delegate, const std::string &p_function_name, ScriptValue *const *const p_arguments, int p_argument_count, ScriptInterpreter &p_interpreter);
