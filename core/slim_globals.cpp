...
const std::string SLIM_TSK_METADATA_SCHEMA =
...
const std::string SLIM_TSK_EDGE_METADATA_SCHEMA = "";
const std::string SLIM_TSK_SITE_METADATA_SCHEMA = "";

const std::string SLIM_TSK_MUTATION_METADATA_SCHEMA =
...
const std::string SLIM_TSK_NODE_METADATA_SCHEMA =
"{\"$schema\":\"http://json-schema.org/schema#\",\"additionalProperties\":false,\"codec\":\"struct\",\"description\":\"SLiM schema for node metadata.\",\"examples\":[{\"genome_type\":0,\"is_null\":false,\"slim_id\":123}],\"properties\":{\"genome_type\":{\"binaryFormat\":\"B\",\"description\":\"The 'type' of this genome (0 for autosome, 1 for X, 2 for Y).\",\"index\":2,\"type\":\"integer\"},\"is_null\":{\"binaryFormat\":\"B\",\"description\":\"Whether this node describes a 'null' (non-existant) chromosome.\",\"index\":1,\"type\":\"integer\"},\"slim_id\":{\"binaryFormat\":\"q\",\"description\":\"The 'pedigree ID' of this chromosome in SLiM.\",\"index\":0,\"type\":\"integer\"}},\"required\":[\"slim_id\",\"is_null\",\"genome_type\"],\"type\":[\"object\",\"null\"]}";

const std::string SLIM_TSK_INDIVIDUAL_METADATA_SCHEMA =
...
const std::string SLIM_TSK_POPULATION_METADATA_SCHEMA = 
...
"\"properties\":{\"bounds_x0\":{\"binaryFormat\":\"d\",\"description\":\"The minimum x-coordinate in this subpopulation.\",\"index\":6,\"type\":\"number\"},\"bounds_x1\":{\"binaryFormat\":\"d\",\"description\":\"The maximum x-coordinate in this subpopulation.\",\"index\":7,\"type\":\"number\"},\"bounds_y0\":{\"binaryFormat\":\"d\",\"description\":\"The minimum y-coordinate in this subpopulation.\",\"index\":8,\"type\":\"number\"},\"bounds_y1\":{\"binaryFormat\":\"d\",\"description\":\"The maximum y-coordinate in this subpopulation.\",\"index\":9,\"type\":\"number\"},\"bounds_z0\":{\"binaryFormat\":\"d\",\"description\":\"The minimum z-coordinate in this subpopulation.\",\"index\":10,\"type\":\"number\"},\"bounds_z1\":{\"binaryFormat\":\"d\",\"description\":\"The maximum z-coordinate in this subpopulation.\",\"index\":11,\"type\":\"number\"},\"female_cloning_fraction\":{\"binaryFormat\":\"d\",\"description\":\"The frequency with which females in this subpopulation reproduce clonally (for WF models).\",\"index\":3,\"type\":\"number\"},\"male_cloning_fraction\":{\"binaryFormat\":\"d\",\"description\":\"The frequency with which males in this subpopulation reproduce clonally (for WF models).\",\"index\":4,\"type\":\"number\"},\"migration_records\":{\"index\":13,\"items\":{\"additionalProperties\":false,"
