...
const std::string &gStr_haplosomesFromParent1NonNull = EidosRegisteredString("haplosomesFromParent1NonNull", gID_haplosomesFromParent1NonNull);
const std::string &gStr_haplosomesFromParent2NonNull = EidosRegisteredString("haplosomesFromParent2NonNull", gID_haplosomesFromParent2NonNull);
