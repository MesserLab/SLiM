...
const std::string &gStr_contigAssembly = EidosRegisteredString("contigAssembly", gID_contigAssembly);
const std::string &gStr_contigURL = EidosRegisteredString("contigURL", gID_contigURL);
...
const std::string &gStr_calculateFitness = EidosRegisteredString("calculateFitness", gID_calculateFitness);
const std::string &gStr_calculatePhenotype = EidosRegisteredString("calculatePhenotype", gID_calculatePhenotype);
