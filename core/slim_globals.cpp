...
const std::string &gStr_distributionTypeForTrait = EidosRegisteredString("distributionTypeForTrait", gID_distributionTypeForTrait);
const std::string &gStr_distributionParamsForTrait = EidosRegisteredString("distributionParamsForTrait", gID_distributionParamsForTrait);
...
const std::string &gStr_setDistributionForTrait = EidosRegisteredString("setDistributionForTrait", gID_setDistributionForTrait);
