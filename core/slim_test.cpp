...
void _RunSLiMSimTests(void)
{
	...
	SLiMAssertScriptStop(gen1_setup_p1 + "1 { b = sim.rescheduleScriptBlock(s1, start=25, end=29); r = apply(b, 'applyValue.start:applyValue.end;'); if (identical(r, matrix(25:29))) stop(); } s1 10 { }", __LINE__);
	SLiMAssertScriptStop(gen1_setup_p1 + "1 { b = sim.rescheduleScriptBlock(s1, start=NULL, end=29); r = apply(b, 'applyValue.start:applyValue.end;'); if (identical(r, matrix(1:29))) stop(); } s1 10 { }", __LINE__);
	SLiMAssertScriptStop(gen1_setup_p1 + "1 { b = sim.rescheduleScriptBlock(s1, end=29); r = apply(b, 'applyValue.start:applyValue.end;'); if (identical(r, matrix(1:29))) stop(); } s1 10 { }", __LINE__);
	...
	SLiMAssertScriptStop(gen1_setup_p1 + "1 { b = sim.rescheduleScriptBlock(s1, generations=25:28); r = apply(b, 'applyValue.start:applyValue.end;'); if (identical(r, matrix(25:28))) stop(); } s1 10 { }", __LINE__);
