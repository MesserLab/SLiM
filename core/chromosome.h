...
private:
	...
	// This vector contains all the mutations that are segregating in the population for this chromosome.  It is unordered.
	MutationRun mutation_registry_;							// OWNED POINTERS: all segregating mutations for this chromosome
...
public:
	...
	inline MutationRun &MutationRegistryRun(void) { return mutation_registry_; }
	
	void MutationRegistryAdd(Mutation *p_mutation, bool p_autogenerated);
	void MutationRegistryClear(void) { mutation_registry_.clear(); }
