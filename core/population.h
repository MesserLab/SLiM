...
public:
	...
	std::vector<SLIMCONST Substitution*> substitutions_;	// OWNED POINTERS: Substitution objects for all fixed mutations
	...
	void IntroduceMutation(SLIMCONST IntroducedMutation &p_introduced_mutation);
	
	// output trajectories of followed mutations and set selection_coeff_ = 0 for partial sweeps 
	void TrackMutations(int p_generation, const std::vector<MutationType*> &p_tracked_mutations, std::vector<SLIMCONST PartialSweep*> *p_partial_sweeps);
