...
public:
	...
	slim_generation_t *mutationLossTimes = nullptr;			// histogram bins: {1 bin per mutation-type} for 10 generations, realloced outward to add new generation bins as needed
	uint32_t mutationLossGenSlots = 0;						// the number of generation-sized slots (with bins per mutation-type) presently allocated
	slim_generation_t *mutationFixationTimes = nullptr;		// histogram bins: {1 bin per mutation-type} for 10 generations, realloced outward to add new generation bins as needed
	...
	slim_generation_t fitnessHistoryLength = 0;				// the number of entries in the fitnessHistory buffer
#endif
