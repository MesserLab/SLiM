...
public:
	...
	void AutogenerationConfigurationChanged(void);	// called when a GenomicElementType / MutationType is changed
	void CheckOptimizationFlags(void);				// essentially checks what AutogenerationConfigurationChanged() does
	
	inline __attribute__((always_inline)) void NoteAutogeneratedMutation(Mutation *p_mut)
	{
	...
	inline __attribute__((always_inline)) void NoteChangedMutation(Mutation *p_mut)
	{
