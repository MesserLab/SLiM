...
/*
 ...
 Tier-parameterized SIMD kernel implementations for Eidos math operations.

 This file is the shared body of the SIMD runtime-dispatch system.  It is
 included once per instruction-set tier by eidos_simd_scalar.cpp,
 eidos_simd_sse42.cpp, eidos_simd_avx2.cpp, and eidos_simd_neon.cpp.  Each
 includer first defines EIDOS_SIMD_IMPL_NAMESPACE and the EIDOS_HAS_* macro
 for its tier, then includes this file; the preprocessor blocks below select
 the matching intrinsics (or the scalar fallback).  See eidos_simd.h for the
 dispatch design and the rationale (issue #628).

 There is deliberately no include guard: this file is a template body meant
 to be expanded into a different namespace in each translation unit that
 includes it.  Each translation unit must include it exactly once.

 */

#ifndef EIDOS_SIMD_IMPL_NAMESPACE
#error "Define EIDOS_SIMD_IMPL_NAMESPACE (and any EIDOS_HAS_* tier macro) before including eidos_simd_impl.h"
#endif

#include <cstdint>
#include <cmath>
#include <cstring>		// SLEEF's inline headers use memcpy() without including this themselves
...
namespace EIDOS_SIMD_IMPL_NAMESPACE {

// ---------------------
// Square Root: sqrt(x)
// ---------------------
void sqrt_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// ---------------------
void abs_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Floor: floor(x)
// ---------------------
void floor_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Ceil: ceil(x)
// ---------------------
void ceil_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Truncate: trunc(x)
// ---------------------
void trunc_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Round: round(x)
// ---------------------
void round_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Exponential: exp(x)
// ---------------------
void exp_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Natural Log: log(x)
// ---------------------
void log_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Log base 10: log10(x)
// ---------------------
void log10_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Log base 2: log2(x)
// ---------------------
void log2_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Sine: sin(x)
// ---------------------
void sin_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Cosine: cos(x)
// ---------------------
void cos_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Tangent: tan(x)
// ---------------------
void tan_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Arc Sine: asin(x)
// ---------------------
void asin_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Arc Cosine: acos(x)
// ---------------------
void acos_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// Arc Tangent: atan(x)
// ---------------------
void atan_float64(const double *input, double *output, int64_t count)
{
    int64_t i = 0;
...
// ---------------------
void atan2_float64(const double *y, const double *x, double *output, int64_t count)
{
    int64_t i = 0;
...
// Power: pow(x, y) = x^y
// ---------------------
void pow_float64(const double *base, const double *exp, double *output, int64_t count)
{
    int64_t i = 0;
...
void pow_float64_scalar_exp(const double *base, double exp_scalar, double *output, int64_t count)
{
    int64_t i = 0;
...
void pow_float64_scalar_base(double base_scalar, const double *exp, double *output, int64_t count)
{
    int64_t i = 0;
...
// Sum: sum(x)
// ---------------------
double sum_float64(const double *input, int64_t count)
{
    double sum = 0.0;
    int64_t i = 0;
...
// Product: product(x)
// ---------------------
double product_float64(const double *input, int64_t count)
{
    double prod = 1.0;
    int64_t i = 0;
...
// ---------------------
void exp_float32(const float *input, float *output, int64_t count)
{
    int64_t i = 0;
...
void exp_kernel_float32(float *distances, int64_t count, float fmax, float lambda)
{
    int64_t i = 0;
...
void normal_kernel_float32(float *distances, int64_t count, float fmax, float two_sigma_sq)
{
    int64_t i = 0;
...
void tdist_kernel_float32(float *distances, int64_t count, float fmax, float nu, float tau)
{
    int64_t i = 0;
...
void cauchy_kernel_float32(float *distances, int64_t count, float fmax, float lambda)
{
    int64_t i = 0;
...
void linear_kernel_float32(float *distances, int64_t count, float fmax, float max_distance)
{
    int64_t i = 0;
...
void convolve_dot_product_float64(
...
void convolve_dot_product_scaled_float64(
    const double *kernel_ptr, const double *pixel_ptr,
