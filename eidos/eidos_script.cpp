...
{
	THREAD_SAFETY_IN_ANY_PARALLEL("EidosScript::Tokenize():  token_stream_ change");
...
{
	THREAD_SAFETY_IN_ANY_PARALLEL("EidosScript::Parse_InterpreterBlock(): parse_root_ change");
