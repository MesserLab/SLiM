...
EidosValue_SP Eidos_ExecuteFunction_dbeta(const EidosValue_SP *const p_arguments, int p_argument_count, EidosInterpreter &p_interpreter);
...
EidosValue_SP Eidos_ExecuteFunction_dexp(const EidosValue_SP *const p_arguments, int p_argument_count, EidosInterpreter &p_interpreter);
...
EidosValue_SP Eidos_ExecuteFunction_dgamma(const EidosValue_SP *const p_arguments, int p_argument_count, EidosInterpreter &p_interpreter);
...
EidosValue_SP Eidos_ExecuteFunction_tabulate(const EidosValue_SP *const p_arguments, int p_argument_count, EidosInterpreter &p_interpreter);
