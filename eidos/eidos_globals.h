...
{
	THREAD_SAFETY_IN_ANY_PARALLEL("RestoreErrorPosition(): gEidosErrorContext change");
...
{
	THREAD_SAFETY_IN_ANY_PARALLEL("ClearErrorPosition(): gEidosErrorContext change");
