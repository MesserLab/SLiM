...
EidosToken::EidosToken(EidosTokenType p_token_type, const string &p_token_string, int p_token_start, int p_token_end, int32_t p_token_UTF16_start, int32_t p_token_UTF16_end) :
...
ostream &operator<<(ostream &p_outstream, const EidosToken &p_token)
{
